...
#define VIDEO_JPG_FILE_SIGNATURE "Lio/agora/recording/common/Common$VideoJpgFile;"
...
#define SN_MTD_VIDEO_JPG_FILE_INIT "(Lio/agora/recording/common/Common;)V"
//class name
//VIDEO
...
#define CN_VIDEO_JPG_FILE "io/agora/recording/common/Common$VideoJpgFile"
...
#define FID_VIDEO_JPG_FILE "jpg_file"
#define FID_FRAME_MS "frame_ms"
#define FID_FILE_NAME "file_name"
...
static JavaObjectMethod jVideoFrameMethods[] = {
  ...
  {MID_JPG_FILE, "jpg_file", "Lio/agora/recording/common/Common$VideoJpgFile;"}
};
...
enum FID_JPGFILE{
  FID_JPG_FILE_FRAMEMS = 0,
  FID_JPG_FILE_NAME = 1,
  FID_JPGFILENUM = 2
};
static JavaObjectMethod jVideoJpgFileFields[] = {
  {FID_JPG_FILE_FRAMEMS, FID_FRAME_MS, LONG_SIGNATURE},
  {FID_JPG_FILE_NAME, FID_FILE_NAME, STRING_SIGNATURE},
};
//audio
enum FID_AUDIOFRAME{
  FID_AF_TYPE = 0,
