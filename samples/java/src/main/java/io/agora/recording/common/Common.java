...
public class Common{
  ...
  public enum VIDEO_FORMAT_TYPE {
     ...
     * <ul>
     *   <li>Individual mode ({@link io.agora.recording.common.RecordingConfig#isMixingEnabled isMixingEnabled} is set as `false`): MP4 or WebM video and JPG files are supported. </li>
     *   <li>Composite mode ({@link io.agora.recording.common.RecordingConfig#isMixingEnabled isMixingEnabled} is set as `true`): MP4 or WebM video files for combined streams and JPG files for individual streams are supported. </li>
     * </ul>
     */
  ...
  public class VideoFrame {
    /** If `VideoFrame` is in YUV format, then YUV points to video data in YUV format. See {@link io.agora.recording.common.Common#VideoYuvFrame VideoYuvFrame}. */
    public VideoYuvFrame yuv;
    /** If `VideoFrame` is in H.264 format, then H.264 points to video data in H.264 format. See {@link io.agora.recording.common.Common#VideoH264Frame VideoH264Frame}. */
    public VideoH264Frame h264;
    /** If `VideoFrame` is in H.265 format, then H.265 points to video data in H.265 format. See {@link io.agora.recording.common.Common#VideoH265Frame VideoH265Frame}. */
    public VideoH265Frame h265;
    /** If `VideoFrame` is in JPG format, then JPG points to video data in JPG format. See {@link io.agora.recording.common.Common#VideoJpgFrame VideoJpgFrame}. */
    public VideoJpgFrame jpg;
    /** If `VideoFrame` is in JPG file format, then JPG file points to video data in JPG file format. See {@link io.agora.recording.common.Common#VideoJpgFile VideoJpgFile}. */
